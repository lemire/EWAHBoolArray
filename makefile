VPATH = src:headers
ifeq ($(DEBUG),1)
CXXFLAGS=-Iheaders -std=c++11 -O3 -ggdb -D_GLIBCXX_DEBUG -Wall -Wextra   -Wshadow  -Wcast-qual -Wwrite-strings  -Wpointer-arith -Winit-self  
else
CXXFLAGS=-Iheaders -std=c++11 -O3 -Wall -Wextra  -Wshadow  -Wcast-qual -Wwrite-strings  -Wpointer-arith -Winit-self  
endif
