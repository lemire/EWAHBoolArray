...
package: 
	...
	cd ..;zip -9 ./EWAHBoolArray/EWAHBoolArray.0.3.4-src.zip ./EWAHBoolArray/README ./EWAHBoolArray/CHANGELOG ./EWAHBoolArray/makefile ./EWAHBoolArray/example.cpp ./EWAHBoolArray/headers/*.h ./EWAHBoolArray/src/*.cpp
clean: 
